...
class CustomDatePicker extends StatefulWidget {
  ...
  CustomDatePicker({
    super.key,
    required this.hasDefaultDateTime,
...
class _CustomDatePickerState extends State<CustomDatePicker> {
  ...
  Widget _buildPicker() {
    return _CustomMonthPicker(
      key: _monthPickerKey,
      hasDefaultDateTime: widget.hasDefaultDateTime,
...
class _CustomMonthPickerState extends State<_CustomMonthPicker> {
  ...
  void initState() {
    super.initState();
    _currentDisplayedMonthDate = widget.initialMonth;
  ...
  @override
  void didUpdateWidget(_CustomMonthPicker oldWidget) {
    super.didUpdateWidget(oldWidget);
  ...
  void _handleMonthPageChanged(int monthPage) {
    setState(() {
      ...
      if (!DateUtils.isSameMonth(_currentMonth, monthDate)) {
        ...
        _handleMonthChanged(_currentMonth);
...
class _CustomDayPickerState extends State<_CustomDayPicker> {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle headerStyle = AppTextStyles.defaultTextStyle
    ...
    while (day < daysInMonth) {
      ...
      if (day < 1) {
        ...
        if (isSelectedDay) {
          ...
          dayColor =
              widget.hasDefaultDateTime ? selectedDayColor : enabledDayColor;
          decoration = BoxDecoration(
            color: widget.hasDefaultDateTime
